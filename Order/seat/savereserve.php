...
$sql = "INSERT INTO `z_userdinnerinfo` (`id`, `name`, `sex`, `num`,`dinertime`,`openid`,`phone`,`locid`, `addtime`) VALUES (NULL, '{$name}', {$sex}, {$num}, {$dinertimestamp},'{$openid}','{$phone}',{$locid},CURRENT_TIMESTAMP);";
$mysql->runSql($sql);
if ($mysql->errno() != 0)
{
