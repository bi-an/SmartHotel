...
$redirect_uri = "http://kladz.applinzi.com/zhzg/Order/seat/reserve.php";
...
$sql=mysql_query("select openid from z_userdinnerinfo where openid = '$openid' ");
if($sql){
...
if($row[0]==$openid )
{
	echo "您已经提交过预约单！<br/>如需修改，请在“我的”->“我的订单”中查看和修改！";
	exit();
}
$mysql = SaeDB::getInstance();//获取mysql实例
$sql = "SELECT `Id`,`Name` FROM  `z_hotel` LIMIT 10";//查询分店
